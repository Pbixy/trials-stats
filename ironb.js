...
//                   "MCount", "Medal Names", "Medal Values", "Medal Weights", 
                  "AvgKillDistance", "AvgDeathDistance", "AvgLifespan", 
    ...
    summary.forEach(function (r) { //r.matchRatio, r.roundWins, r.roundLosses, r.roundRatio, //r.mCount, r.mNames, r.mValues, r.mWeights, 
        writer.write([r.date, r.map, r.activityInstanceId.toString(), r.matchWins, r.matchLosses, r.matchScore, r.playerScore, r.playerK, r.playerD, r.playerA, r.playerKD, r.playerKAD, r.whash, r.wkills, r.wpkills, r.gameType, r.playerClass, r.pavgKillDist, r.pavgDeathDist, r.pavgLifespan, r.pavgScoreperKill, r.pavgScoreperLife, r.plongestKillSpree, r.plongestLife, r.pSecPlayed, r.pSuicides, r.ptotKillDist, r.wBestType, r.wKGrenade, r.wKMelee, r.wKSuper, r.pZonesCaptured, r.pZonesNeutralized, r.psparksCaptured, r.pslamDunks, r.pstyleDunks, r.pdunkKills, r.pcarrierKills, r.ptagCaptures, r.pcapturedYourOwnKill, r.plostTagToOpponent, r.precoveredOwnDeadTag, r.ptagsCapturedPerTagLost]);
    });
    writer.end();
}
